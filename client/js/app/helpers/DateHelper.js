    ...
    execute: function () {
      ...
      _export('DateHelper', DateHelper = function () {
        ...
        _createClass(DateHelper, null, [{
          key: 'textoParaData',
          value: function textoParaData(dataStr) {
            ...
            return new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(dataStr.split('-').map(function (item, index) {
              return item - index % 2;
            })))))();
          }
        }, {
